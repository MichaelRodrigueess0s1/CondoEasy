...
class TipoUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idtipo_usuario, dscTipo', 'required'),
			array('idtipo_usuario', 'numerical', 'integerOnly'=>true),
			array('dscTipo', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idtipo_usuario, dscTipo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'usuarios' => array(self::HAS_MANY, 'Usuario', 'idtipo_usuario'),
		);
	}
